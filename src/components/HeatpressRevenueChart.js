...
const HeatpressRevenueChart = ({title = 'Heatpress Revenue', onData}) => {
  ...
  const fetchChartData = async () => {
    ...
    try {
      ...
      const response = await revAPI.getHeatpressRevenue(filter.value);

      console.log('Heatpress Chart Response:', response.data);
      ...
      console.error('Heatpress chart fetch error:', err);
...
export default HeatpressRevenueChart;