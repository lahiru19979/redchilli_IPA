...
const SalesChart = ({
  ...
  const avgSales = data.values.length > 0 ? totalSales / data.values.length : 0;
  const maxSales = Math.max(...data.values);
  const minSales = Math.min(...data.values.filter(v => v > 0));
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={styles.statItem}>
          <Text style={[styles.statValue, {color: barColor}]}>
            Rs. {formatShort(avgSales)}
          </Text>
          <Text style={styles.statLabel}>Average</Text>
        </View>
        <View style={styles.statDivider} />
        <View style={styles.statItem}>
          <Text style={[styles.statValue, {color: highColor}]}>
              ...
              >
                ...
                <View style={styles.valueLabelContainer}>
                  <Text
                    style={[
                      styles.valueLabel,
                      isHighest && {color: highColor},
                      isLowest && {color: lowColor},
